...
param.path_separation = [mount_path, 'expResult/MPE-informed Source Separator/mpe_informed_rwcdict_v3/algorithm/'];
% the path for saving performance
param.path_perf = [mount_path, 'expResult/MPE-informed Source Separator/mpe_informed_rwcdict_v3/perf/'];
% the path for saving reconstruction result
param.path_recon = [mount_path, 'expResult/MPE-informed Source Separator/mpe_informed_rwcdict_v3/reconstruction/'];
% the path for saving the data to be sent via email
param.path_sendData = [mount_path, 'expResult/MPE-informed Source Separator/mpe_informed_rwcdict_v3/sendData/'];
...
%     param.algorithm.mpe.use_all = 0;
    ...
    param.algorithm.use_inst = 0; % set as 1 for using instrument recognition, 
                                  % but this default setup neglects many
                                  % settings, please use another script
%         %% Spectrogram
...
%         param.algorithm.NMF.error_criterion = 'KL'; % KL or Fro, default is Frobenius norm
%         param.algorithm.NMF.randH0 = 0;
    %% CSC    

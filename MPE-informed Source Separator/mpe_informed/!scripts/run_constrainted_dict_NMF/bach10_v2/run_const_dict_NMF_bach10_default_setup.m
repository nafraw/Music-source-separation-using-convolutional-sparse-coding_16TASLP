...
%     dict_root_path = 'C:/MPE-informed Source Separator/nmf_dict/';
...
param.path_separation = [mount_path, 'expResult/MPE-informed Source Separator/mpe_informed_dict_NMF_v2/algorithm/'];
% the path for saving performance
param.path_perf = [mount_path, 'expResult/MPE-informed Source Separator/mpe_informed_dict_NMF_v2/perf/'];
% the path for saving reconstruction result
param.path_recon = [mount_path, 'expResult/MPE-informed Source Separator/mpe_informed_dict_NMF_v2/reconstruction/'];
% the path for saving the data to be sent via email
param.path_sendData = [mount_path, 'expResult/MPE-informed Source Separator/mpe_informed_dict_NMF_v2/sendData/'];

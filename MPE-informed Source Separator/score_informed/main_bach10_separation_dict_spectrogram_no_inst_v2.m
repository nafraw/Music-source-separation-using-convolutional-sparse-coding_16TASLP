...
%  param.
function [SSperf] = main_bach10_separation_dict_spectrogram_no_inst_v2(param)
% start_max_pool;
...
%             partition_problem(param.path_target_corpus{fid}, param.prob_partition);
        ...
        [W, H, maskD, inst_id] = score_informed_dict_NMF_wo_time_inst(D, pitch, dict_sid, freq, p_stft_music, param, fid);        
        %% output stage

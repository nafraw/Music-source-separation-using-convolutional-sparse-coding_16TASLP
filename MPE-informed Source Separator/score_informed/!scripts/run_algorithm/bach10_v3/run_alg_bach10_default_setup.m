...
param.path_separation = [mount_path, 'expResult/MPE-informed Source Separator/score_informed_v3/algorithm/'];
% the path for saving performance
param.path_perf = [mount_path, 'expResult/MPE-informed Source Separator/score_informed_v3/perf/'];
% the path for saving reconstruction result
param.path_recon = [mount_path, 'expResult/MPE-informed Source Separator/score_informed_v3/reconstruction/'];
% the path for saving the data to be sent via email
param.path_sendData = [mount_path, 'expResult/MPE-informed Source Separator/score_informed_v3/sendData/'];

...
%  param.
function [SSperf] = main_bach10_separation_dict_spectrogram(param)
% start_max_pool;
...
%         [maskD, partition_set] = score_informed_CSC(param, fid, P, D, zero_pad, dict_sid, pitch);
        [W, H, maskD, inst_id] = score_informed_dict_NMF(D, pitch, dict_sid, freq, p_stft_music, param, fid);
        %% output stage

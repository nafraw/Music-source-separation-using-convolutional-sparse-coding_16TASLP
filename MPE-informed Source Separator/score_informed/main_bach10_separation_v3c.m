...
%  param.
function [SSperf] = main_bach10_separation_v3c(param)
start_max_pool(8);
...
%         [maskD, partition_set] = score_informed_CSC_v3(param, fid, P, D, dict_sid, pitch);
%         [maskD, partition_set] = score_informed_CSC_v3b(param, fid, P, D, dict_sid, pitch);
        [maskD, partition_set] = score_informed_CSC_v3c(param, fid, P, D, dict_sid, pitch);
        %% output stage
